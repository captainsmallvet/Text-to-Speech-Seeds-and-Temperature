...
const APP_VERSION = "v1.9.35 (UI Refinement)";
const LAST_UPDATED = "Nov 22, 2025 18:30";
    ...
    <div className="min-h-screen bg-gray-950 text-white p-4 lg:p-8 font-sans">
      ...
      {/* API Key Management Bar */}
        ...
        <header className="text-center mb-10 flex flex-col items-center">
          ...
          <p className="text-xl lg:text-2xl font-bold text-emerald-400 mt-2 tracking-wide">
            Voice Seeds & Model Temperature
          </p>
